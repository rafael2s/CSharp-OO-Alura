...
namespace ByteBank.SistemaAgencia
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // O codigo abaixo faz exatamente o que os codigos acima 'IEnumerable...' e 'IOrderedEnumerable...'
            // fazem, porem de uma forma muito mais elegante.
